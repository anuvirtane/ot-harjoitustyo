...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_pystyy_ostamaan_edullisen_lounaan_kun_tasaraha_kortilla(self):
        kortti = Maksukortti(2.5)
        kortti.syo_edullisesti()
        self.assertEqual("Kortilla on rahaa 0.0 euroa", str(kortti))
    
    def test_kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_tasaraha_kortilla(self):
